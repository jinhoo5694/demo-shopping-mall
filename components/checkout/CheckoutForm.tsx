  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="홍길동"
              required
              className="w-full pl-12 pr-4 py-3 glass-subtle rounded-xl border border-gray-200 focus:border-purple-400 focus:ring-2 focus:ring-purple-200 transition-smooth outline-none"
            />
          </div>
        </div>
          ...
          <div className="flex gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                required
                readOnly
                className="w-full pl-12 pr-4 py-3 glass-subtle rounded-xl border border-gray-200 bg-gray-50 outline-none"
              />
            </div>
            <motion.button
        ...
        {/* 상세주소 */}
        <div>
          <label htmlFor="detailAddress" className="block text-sm font-semibold text-gray-700 mb-2">
          ...
          <input
            ...
            required
            className="w-full px-4 py-3 glass-subtle rounded-xl border border-gray-200 focus:border-purple-400 focus:ring-2 focus:ring-purple-200 transition-smooth outline-none"
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={3}
            className="w-full px-4 py-3 glass-subtle rounded-xl border border-gray-200 focus:border-purple-400 focus:ring-2 focus:ring-purple-200 transition-smooth outline-none resize-none"
          />
        </div>
      </div>
